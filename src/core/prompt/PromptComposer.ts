  ...
  static composeBlocks(opts: PromptComposeOptions): PromptBlock[] {
    ...
    blocks.push({
      ...
      content: [
        ...
        `- [문서 서식 절대 금지] 마크다운 제목(#, ##, ###), 글머리 기호(-, •), 번호 매기기(1., 2.), '특징:', '추가 정보:', 목차 등을 절대 출력하지 않는다. 오직 사람이 입으로 발화하는 친근한 대화 문장으로만 말한다.`,
        `- 캐릭터의 신체 행동 묘사, 제스처, 표정, 또는 짧은 속마음만 반드시 *별표(이탤릭)*로 감싸서 작성한다. (예: *살며시 고개를 끄덕인다.*, *눈을 반짝이며 미소 짓는다.*)`,
        `- 별표(*...*)는 캐릭터 본인의 행동/표정에만 사용하며, 설명 대상의 단어나 명사, 배경 지식에는 절대 별표를 쪼개어 감싸지 않는다.`,
